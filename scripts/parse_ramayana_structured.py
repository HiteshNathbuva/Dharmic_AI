...
INPUT_FILE = "data/ramayana/ramayana_structured.txt"
OUTPUT_FILE = "data/metadata_ramayana_structured.json"
...
def parse_ramayana():
    ...
    print(f"✅ Parsed {len(records)} Ramayana verses successfully")
